## 今日热点：AI Agent 工具链全面扩张
今天的 GitHub 热点明显围绕 AI Agent 生态加速展开：从 Claude Code、Codex、Gemini、Cursor 等编码代理的技能库、插件、任务委派、终端多路复用、持久化规划，到网页 GUI 控制、Unity 编辑器自动化、设计系统 agent-ready 化，再到本地 AI 会议助手、AI 渗透测试、WiFi 空间感知、自托管照片与 ROM 管理等应用场景，显示开源社区正在把大模型能力从“对话与写代码”推进到更具体的工作流、生产工具、个人数据管理和安全自动化中。具体项目摘要如下：

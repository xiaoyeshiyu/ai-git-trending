## 今日热点：AI Agent 工程化与本地智能工具爆发
今天的 GitHub 热点集中在 AI Agent 从提示词、技能库、插件协作到多代理工作流的工程化落地，同时延伸到本地隐私优先的会议转写、视频理解、网页抓取、书签知识管理、向量数据库、终端多路复用、WiFi 空间感知与开发者用量统计等方向，显示出开发者正在把大模型能力嵌入更细颗粒度、更可控、更贴近日常生产力的工具链中，具体项目摘要如下：

## 今日热点：AI 代理生态加速落地，端侧智能与上下文基础设施成为焦点
今日技术热点聚焦 AI 代理从能力编排走向实际工作流，涵盖 Agent Skills、统一智能工作区、模型路由、可追责的图原生基础设施、RAG 与知识管理，同时延伸至端侧小模型、本地语音识别、模型训练与推理、音视频生成、图像生成 3D、数学动画、团队协作，以及 OSINT 与攻击面情报工具，具体项目摘要如下：

## 今日热点：智能体运行时与开发工具生态加速演进
今日技术热点聚焦于智能体基础设施与生产力工具的融合，从 Agent Substrate、Google AX 等开放式智能体编排运行时，到 Univer 面向表格、文档、幻灯片、画布、关系表和 PDF 的办公能力，再到 Claude Code 配置监控、OpenRouter 智能体工具接入及通过代码编辑视频的 Video Use，同时覆盖金融服务、移动设备取证与潜在入侵检测等垂直场景，体现出智能体正从对话应用走向可编排、可操作、可审计的复杂工作流，具体项目摘要如下：

## 今日热点：AI 编程代理与代码理解工具链
今天的热点明显围绕“让 AI 更像工程助手”展开：一边是面向编码工作流和长期自治任务的自我改进代理、代码库知识图谱 RAG、生产级 agent skills、以及多角色 AI agency 体系，另一边则延伸到具体工程场景中的进程溯源、身份认证、股票智能分析、图像生成工作台和法律工作评测基准，显示出 AI 正从通用聊天走向可落地、可协作、可审计的生产系统，同时也开始覆盖 Google 产品技能、代码编辑与多语言 monorepo 理解等更细分的能力边界，具体项目摘要如下：

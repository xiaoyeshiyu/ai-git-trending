## 今日热点：AI 工程化与本地智能基础设施
今天的技术热点集中在 AI 从模型能力走向工程落地与本地化基础设施：既有面向流式数据的 3D 场景重建基础模型、70B 大模型低显存推理和 CLI 智能体，也有语义元数据标准、产品分析与可观测平台、代码智能图谱、本地优先的搜索抓取研究工具，以及设计工程技能、从零构建 AI 工程能力和经典技术复刻学习资源，整体呈现出围绕 AI 编码、数据语义、开发者体验与低成本部署的全链路演进。具体项目摘要如下：

## 今日热点：AI 代理工具链走向本地化、可组合与多模态
今天的热门项目集中呈现出 AI 工程基础设施继续下沉到开发者工作流的趋势：一方面，系统提示词泄露整理、代理技能库、Claude/Codex/Gemini 等多代理插件与终端复用器反映出开发者正在把 AI 编码代理做成可扩展、可委派、可治理的生产工具；另一方面，本地优先的会议助手、视频理解、网页抓取、书签管理、近 30 天跨平台研究技能等项目显示 AI 正从单一对话扩展到音频、视频、网页和知识管理场景；同时，WiFi 空间感知、轻量向量数据库、Awesome 资源索引和多代理工作区管理也补齐了从感知、检索到协作编排的底层能力。具体项目摘要如下：

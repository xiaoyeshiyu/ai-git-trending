## 今日热点：AI Agent 基础设施与智能生产力生态加速成形
今日技术热点聚焦 AI Agent 的运行时、编排框架、开发方法、工具调用、代码理解与设计能力，同时延伸至表格文档一体化办公、金融数据与智能投研、视频编辑、3D Gaussian Splatting、移动设备取证及开源市场终端，覆盖从底层 Agent Substrate、Harness SDK、MCP 服务到面向开发者和终端用户的完整应用生态，具体项目摘要如下：

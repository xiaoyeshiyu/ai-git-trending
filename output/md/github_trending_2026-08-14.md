...
今天的 GitHub 热点集中在 AI Agent 生态、上下文与记忆基础设施、本地模型部署、多模态生成和安全情报工具等方向：从 Agent Skills、Obsidian 技能、统一 AI 工作区和团队协作空间，到图原生上下文系统、RAG 引擎、模型路由与成本优化，再到端侧基础模型、本地语音转写、LLM/扩散模型训练界面、图片生成 3D 模型、音视频生成模型，以及 OSINT、邮箱足迹检测、数学动画和可复用图表设计工具，整体呈现出 AI 能力正在向更可组合、更本地化、更贴近实际工作流的方向演进。具体项目摘要如下：

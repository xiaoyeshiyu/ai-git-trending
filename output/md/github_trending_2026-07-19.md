## 今日热点：AI 开发工具与本地智能工作流
今天的热门项目明显围绕“AI 进入开发与数据工作流”的主线展开：一边是面向代码审查、CLI 代理、MCP 搜索研究和设计工程技能的本地优先工具，强调上下文压缩、代码库理解和更高效的人机协作；另一边则延伸到产品分析、会话回放、日志与实验等开发者平台能力，以及语义元数据标准化、3D 场景重建和大模型低资源推理等基础能力，反映出从模型应用、工程提效到数据治理的全栈热度。具体项目摘要如下：

<template>
  <div v-if="visible" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm" @click="$emit('close')">
    <div class="relative w-full max-w-6xl max-h-[90vh] overflow-hidden rounded-2xl bg-slate-900 border border-slate-800 shadow-2xl animate-fadeIn" @click.stop>
      <!-- 模态框头部 -->

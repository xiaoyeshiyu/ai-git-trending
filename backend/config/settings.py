...
# Stats activity score constants
STATS_BASE_CONTRIBUTORS = 10
STATS_BASE_STARS = 100
STATS_BASE_FORKS = 50
STATS_MIN_CONTRIBUTORS_SCORE = 5
STATS_MIN_STARS_SCORE = 10
STATS_MIN_FORKS_SCORE = 5

GITHUB_TRENDING_URL = f"https://github.com/trending?since={TRENDING_DATE_RANGE}"
GITHUB_TRENDING_DEVELOPERS_URL = f"https://github.com/trending/developers?since={TRENDING_DATE_RANGE}"

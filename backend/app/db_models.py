    ...
    def add_summarized_project(self, project: Dict):
        ...
        with self.manager.get_session() as session:
            ...
            if summarized:
                ...
                summarized.analysis = project.get('analysis', summarized.analysis or '')
                summarized.tech_domain = project.get('tech_domain', summarized.tech_domain or 'Other')
            else:
                # 创建
                summarized = SummarizedProject(
                    ...
                    tech_domain=project.get('tech_domain', 'Other'),

...
def get_project_details(project_name):
    ...
    try:
        ...
        with db._get_connection() as conn:
            ...
            cursor.execute(
                "SELECT name, url, description, language, stars, forks, contributor_count, created_at, updated_at, open_issues, watchers, summary_date, analysis FROM summarized_projects WHERE name = ?",
